/*Ce script sera appellé lorsqu'un utilisateur désire créer un nouveau compte Inox*/
$(document).ready(function() {
	...
	$("#create").click(function() {	
	   ...
	   /*On valide les informations de l'utilisateur dans les inputs affichés à l'écran*/
	   ...
	   {
	      /*On saisie les valeurs des inputs (fournies par l'utilisateur) pour l'envoyer au serveur*/
		  ...
		  $.ajax({
			...
			/*On stringify les données qu'on a saisie de l'utilisateur*/
